...
public class StatzExpansion extends PlaceholderExpansion {
    ...
    public String onPlaceholderRequest(Player player, String identifier) {
        ...
        if (player == null) {
            ...
            return api.getSpecificData(PlayerStat.BLOCKS_BROKEN, player.getUniqueId()) != null ? String.valueOf(api.getSpecificData(PlayerStat.BLOCKS_BROKEN, player.getUniqueId(), new RowRequirement("block", identifier.toUpperCase())).longValue()) : "0";
        } else if (identifier.startsWith("blocks_placed_")) {
            identifier = identifier.replace("blocks_placed_", "");
            return api.getSpecificData(PlayerStat.BLOCKS_PLACED, player.getUniqueId()) != null ? String.valueOf(api.getSpecificData(PlayerStat.BLOCKS_PLACED, player.getUniqueId(), new RowRequirement("block", identifier.toUpperCase())).longValue()) : "0";
